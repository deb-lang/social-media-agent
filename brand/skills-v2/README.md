...
That is the only command you need to remember.

**Installation:** See [INTEGRATION_GUIDE.md](INTEGRATION_GUIDE.md) for installing into Claude Code, Claude Code Desktop, Terminal, and Cursor. The orchestrator scans your
