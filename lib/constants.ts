...
- "static-editorial" — long-form essay layout, masthead + giant headline + dek (other masthead/byline fields default in code)
  Use for: thought leadership and perfectpatient posts that read like a magazine feature
  Props: preHeadline (small teal italic line like "The case for"), headline (giant editorial line, 8-120 chars), headlineEmphasisWord (one word inside headline to italicize), dek (1-3 sentence subtitle, 40-420 chars), authorName (e.g. "By Dr. Reema Patel")
- "static-ticker" — live-dashboard layout, hero number + 4 supporting metrics
  ...
  Props: heroValue (the big number, 1-16 chars), heroDelta (e.g. "↑ 12.4%"), headline (20-180 chars), metrics (exactly 4 of { label, value, delta })
- "static-diptych" — side-by-side comparison: dark tile (negative) vs light tile (positive)
  ...
  Props: left ({ tone:"dark", eyebrow, stat, statLabel, headline }), right ({ tone:"light", eyebrow, stat, statLabel, headline }), source
